...
public class BM2 extends BookManager {
    ...
    void init() {
        ...
        bookList.add(new Book(4L, "위기의 역사", "오건영", Long.parseLong("9791169850360"), LocalDate.parse("2023-07-19")));
        bookList.add(new EBook(4L, "도둑맞은 집중력", "요한 하리", Long.parseLong("979116774098403180"), LocalDate.parse("2023-10-04"),"20"));
        bookList.add(new EBook(5L, "내 주위에는 왜 멍청이가 많을까", "장 프랑수아 마르미옹", Long.parseLong("9788952756879"), LocalDate.parse("2020-02-20"),"30"));
        bookList.add(new EBook(6L, "꿀벌의 예언1", "베르나르 베르베르", Long.parseLong("9788932923413"), LocalDate.parse("2023-06-21"),"40"));
        bookList.add(new AudioBook(8L, "칵테일, 러브, 좀비", "조예은", Long.parseLong("9791190174756"), LocalDate.parse("2023-01-25"),"45","한국어",12));
        bookList.add(new AudioBook(8L, "호밀밭의 파수꾼", "제롬 데이비드 샐린저", Long.parseLong("9788937460470"), LocalDate.parse("2023-01-17"),"50","영어",22));
        bookList.add(new AudioBook(9L, "데미안", "헤르만헤세", Long.parseLong("9791164456338"), LocalDate.parse("2023-03-15"),"55","중국어",32));
        bookList.add(new AudioBook(9L, "인간 실격", "다자이 오사무", Long.parseLong("9788937461033"), LocalDate.parse("2012-04-10"), "65","일본어",42));
        ...
        switch (InputNum) {
            ...
            case "3":
                ...
                AudioBook audiobook = new AudioBook(Long.parseLong(bookInfo[0]),
                        ...
                        Long.parseLong(bookInfo[3]),
                        LocalDate.parse(bookInfo[4]),
                        bookInfo[5],bookInfo[6],Integer.parseInt(bookInfo[7]));
